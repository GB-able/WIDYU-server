...
class SocialLoginStrategyFactoryTest {
    ...
    private SocialLoginStrategyFactory createFactory() {
        ...
        return new SocialLoginStrategyFactory(List.of(kakaoStrategy, naverStrategy, appleStrategy));
    }
    ...
    void KAKAO_provider로_조회_시_카카오_전략을_반환한다() {
        // given
        SocialLoginStrategyFactory factory = createFactory();
