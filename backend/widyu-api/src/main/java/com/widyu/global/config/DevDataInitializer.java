...
public class DevDataInitializer implements CommandLineRunner {
    ...
    protected List<Member> seedFamilyA(String encodedPassword) {
        ...
        seniorProfileRepository.save(SeniorProfile.createSeniorProfile(
                s1, family, null, "101호", "1110001", LocalDate.of(1948, 3, 12)));
        seniorProfileRepository.save(SeniorProfile.createSeniorProfile(
                s2, family, null, "202호", "1110002", LocalDate.of(1952, 11, 5)));
    ...
    protected List<Member> seedFamilyB(String encodedPassword) {
        ...
        seniorProfileRepository.save(SeniorProfile.createSeniorProfile(
                s1, family, null, "303호", "2220001", LocalDate.of(1945, 7, 21)));
